...
function XIcon() {
  return (
    <NavButton id="MenuXButton" title="Menu Button" className = 'inline-flex rounded-full px-4 p-1.5 text-sm font-semibold transition bg-background text-secondary hover:bg-background/70'>
...
function MenuIcon() {
  return (
    <NavButton id="MenuButton" title="Menu Button" className = 'inline-flex rounded-full px-4 p-1.5 text-sm font-semibold transition bg-secondary text-background hover:bg-secondary/70'>
